...
module LunchMoney
  ...
  class SkippedExistingExternalIdObject < ApiModelBase
    ...
    def self.attribute_map
      {
        :'reason' => :'reason',
        :'request_transactions_index' => :'request_transactions_index',
    ...
    def self.openapi_types
      {
        :'reason' => :'String',
        :'request_transactions_index' => :'Integer',
        :'existing_transaction_id' => :'Integer',
        :'request_transaction' => :'InsertTransactionObject'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LunchMoney::SkippedExistingExternalIdObject` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LunchMoney::SkippedExistingExternalIdObject`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'request_transactions_index')
        self.request_transactions_index = attributes[:'request_transactions_index']
      end

      if attributes.key?(:'existing_transaction_id')
        self.existing_transaction_id = attributes[:'existing_transaction_id']
      end

      if attributes.key?(:'request_transaction')
        self.request_transaction = attributes[:'request_transaction']
      end
    end
    ...
    def valid?
      ...
      reason_validator = EnumAttributeValidator.new('String', ["duplicate_external_id", "duplicate_payee_amount_date"])
    ...
    def reason=(reason)
      validator = EnumAttributeValidator.new('String', ["duplicate_external_id", "duplicate_payee_amount_date"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          reason == o.reason &&
          request_transactions_index == o.request_transactions_index &&
          existing_transaction_id == o.existing_transaction_id &&
          request_transaction == o.request_transaction
    end
    ...
    def hash
      [reason, request_transactions_index, existing_transaction_id, request_transaction].hash
    end
