...
module LunchMoney
  class CategoryObject < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'group_id' => :'Integer',
        :'is_group' => :'Boolean',
        :'children' => :'Array<ChildCategoryObject>',
        :'archived' => :'Boolean',
        :'archived_at' => :'Time',
        :'order' => :'Integer',
        :'collapsed' => :'Boolean'
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LunchMoney::CategoryObject` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LunchMoney::CategoryObject`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @collapsed.nil?
        invalid_properties.push('invalid value for "collapsed", collapsed cannot be nil.')
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] collapsed Value to be assigned
    def collapsed=(collapsed)
      if collapsed.nil?
        fail ArgumentError, 'collapsed cannot be nil'
      end
    ...
    def hash
      [id, name, description, is_income, exclude_from_budget, exclude_from_totals, updated_at, created_at, group_id, is_group, children, archived, archived_at, order, collapsed].hash
    end
