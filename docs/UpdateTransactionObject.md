# LunchMoney::UpdateTransactionObject

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **id** | **Integer** | System defined unique identifier of this transaction. Ignored if set. | [optional] |
...
instance = LunchMoney::UpdateTransactionObject.new(
  id: null,
  date: null,
  amount: null,
  currency: null,
