...
module LunchMoney
  class SummaryTotalsBreakdownObject < ApiModelBase
    ...
    attr_accessor :uncategorized_count

    # Total amount, in the user's default currency, of recurring activity coming from un-categorized transactions.
    attr_accessor :uncategorized_recurring
    ...
    def self.attribute_map
      {
        ...
        :'uncategorized_recurring' => :'uncategorized_recurring'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LunchMoney::SummaryTotalsBreakdownObject` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LunchMoney::SummaryTotalsBreakdownObject`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'uncategorized')
        self.uncategorized = attributes[:'uncategorized']
      end

      if attributes.key?(:'uncategorized_count')
        self.uncategorized_count = attributes[:'uncategorized_count']
      end

      if attributes.key?(:'uncategorized_recurring')
        self.uncategorized_recurring = attributes[:'uncategorized_recurring']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          uncategorized_count == o.uncategorized_count &&
          uncategorized_recurring == o.uncategorized_recurring
    end
    ...
    def hash
      [other_activity, recurring_activity, recurring_remaining, recurring_expected, uncategorized, uncategorized_count, uncategorized_recurring].hash
    end
