...
module LunchMoney
  ...
  class SummaryResponseObject < ApiModelBase
    ...
    def self.openapi_types
      {
        :'aligned' => :'Boolean',
        :'categories' => :'Array<SummaryCategoryObject>',
        :'totals' => :'SummaryTotalsObject',
        :'rollover_pool' => :'SummaryRolloverPoolObject'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LunchMoney::SummaryResponseObject` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LunchMoney::SummaryResponseObject`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'aligned')
        self.aligned = attributes[:'aligned']
      else
        self.aligned = nil
      end
      ...
      if attributes.key?(:'rollover_pool')
        self.rollover_pool = attributes[:'rollover_pool']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @aligned.nil?
        invalid_properties.push('invalid value for "aligned", aligned cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @aligned.nil?
      return false if @categories.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] aligned Value to be assigned
    def aligned=(aligned)
      if aligned.nil?
        fail ArgumentError, 'aligned cannot be nil'
      end
    ...
    def hash
      [aligned, categories, totals, rollover_pool].hash
    end
