  ...
  class RecurringObjectMatches < ApiModelBase
    ...
    def self.attribute_map
      {
        ...
        :'expected_occurrence_dates' => :'expected_occurrence_dates',
        :'found_transactions' => :'found_transactions',
        :'missing_transaction_dates' => :'missing_transaction_dates'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'expected_occurrence_dates' => :'Array<Date>',
        :'found_transactions' => :'Array<RecurringObjectMatchesFoundTransactionsInner>',
        :'missing_transaction_dates' => :'Array<Date>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LunchMoney::RecurringObjectMatches` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LunchMoney::RecurringObjectMatches`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'request_start_date')
        self.request_start_date = attributes[:'request_start_date']
      end

      if attributes.key?(:'request_end_date')
        self.request_end_date = attributes[:'request_end_date']
      end

      if attributes.key?(:'expected_occurrence_dates')
        if (value = attributes[:'expected_occurrence_dates']).is_a?(Array)
          self.expected_occurrence_dates = value
        end
      end

      if attributes.key?(:'found_transactions')
        if (value = attributes[:'found_transactions']).is_a?(Array)
          self.found_transactions = value
        end
      end

      if attributes.key?(:'missing_transaction_dates')
        if (value = attributes[:'missing_transaction_dates']).is_a?(Array)
          self.missing_transaction_dates = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          request_start_date == o.request_start_date &&
          request_end_date == o.request_end_date &&
          expected_occurrence_dates == o.expected_occurrence_dates &&
          found_transactions == o.found_transactions &&
          missing_transaction_dates == o.missing_transaction_dates
    end
    ...
    def hash
      [request_start_date, request_end_date, expected_occurrence_dates, found_transactions, missing_transaction_dates].hash
    end
