...
module LunchMoney
  ...
  class SummaryCategoryObject < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'occurrences' => :'Array<SummaryCategoryOccurrenceObject>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LunchMoney::SummaryCategoryObject` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LunchMoney::SummaryCategoryObject`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [category_id, totals, occurrences, rollover_pool].hash
    end
