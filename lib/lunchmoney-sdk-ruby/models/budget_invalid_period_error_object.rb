  ...
  class BudgetInvalidPeriodErrorObject < ApiModelBase
    ...
    def self.attribute_map
      {
        ...
        :'previous_valid_start_date' => :'previous_valid_start_date',
        :'next_valid_start_date' => :'next_valid_start_date',
        :'err_msg' => :'errMsg'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'previous_valid_start_date' => :'Date',
        :'next_valid_start_date' => :'Date',
        :'err_msg' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LunchMoney::BudgetInvalidPeriodErrorObject` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LunchMoney::BudgetInvalidPeriodErrorObject`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'requested_start_date')
        self.requested_start_date = attributes[:'requested_start_date']
      else
        self.requested_start_date = nil
      end

      if attributes.key?(:'previous_valid_start_date')
        self.previous_valid_start_date = attributes[:'previous_valid_start_date']
      end

      if attributes.key?(:'next_valid_start_date')
        self.next_valid_start_date = attributes[:'next_valid_start_date']
      end
    ...
    def list_invalid_properties
      ...
      if @requested_start_date.nil?
        invalid_properties.push('invalid value for "requested_start_date", requested_start_date cannot be nil.')
      end

      if @err_msg.nil?
        invalid_properties.push('invalid value for "err_msg", err_msg cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @requested_start_date.nil?
      return false if @err_msg.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] requested_start_date Value to be assigned
    def requested_start_date=(requested_start_date)
      if requested_start_date.nil?
        fail ArgumentError, 'requested_start_date cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] err_msg Value to be assigned
    def err_msg=(err_msg)
      if err_msg.nil?
        fail ArgumentError, 'err_msg cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          previous_valid_start_date == o.previous_valid_start_date &&
          next_valid_start_date == o.next_valid_start_date &&
          err_msg == o.err_msg
    end
    ...
    def hash
      [message, requested_start_date, previous_valid_start_date, next_valid_start_date, err_msg].hash
    end
