...
module LunchMoney
  ...
  class InsertTransactionsResponseObject < ApiModelBase
    ...
    attr_accessor :skipped_duplicates
    ...
    def self.openapi_types
      {
        ...
        :'skipped_duplicates' => :'Array<SkippedExistingExternalIdObject>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LunchMoney::InsertTransactionsResponseObject` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LunchMoney::InsertTransactionsResponseObject`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'skipped_duplicates')
        if (value = attributes[:'skipped_duplicates']).is_a?(Array)
          self.skipped_duplicates = value
        end
      else
        self.skipped_duplicates = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @skipped_duplicates.nil?
        invalid_properties.push('invalid value for "skipped_duplicates", skipped_duplicates cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @skipped_duplicates.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] skipped_duplicates Value to be assigned
    def skipped_duplicates=(skipped_duplicates)
      if skipped_duplicates.nil?
        fail ArgumentError, 'skipped_duplicates cannot be nil'
      end
    ...
    def hash
      [transactions, skipped_duplicates].hash
    end
